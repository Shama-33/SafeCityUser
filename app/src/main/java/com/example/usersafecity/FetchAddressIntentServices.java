    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (intent != null) {
            ...
            if (addresses == null || addresses.size() == 0) {
                ...
                // Add the street number if available
                String streetNumber = address.getSubThoroughfare();
                if (streetNumber != null) {
                    formattedAddress += streetNumber + ", ";
                }

                // Add the locality (e.g., "West Shewrapara")
                String locality = address.getSubLocality();
                if (locality != null) {
                    formattedAddress += locality;
                }
                String feature=address.getPremises();
                if(feature != null)
                {
                    formattedAddress += " , "+feature;
                }
                String feature2=address.getFeatureName();
                if(feature2 != null)
                {
                    formattedAddress += " , "+feature2;
                }
                String feature3=address.getSubThoroughfare();
                if(feature3 != null)
                {
                    formattedAddress += " , "+feature3;
                }
                String feature4=address.getThoroughfare();
                if(feature4 != null)
                {
                    formattedAddress += " , "+feature4;
                }
                ...
                String str_address=formattedAddress;
